...
info() {
	...
	echo "#########################################################################"
	echo ""
	echo "repository-search-solr6:"
	echo ""
	echo "  JVM:"
	echo ""
	echo "    XMS:            ${REPOSITORY_SEARCH_SOLR6_JAVA_XMS:-1g}"
	echo "    XMX:            ${REPOSITORY_SEARCH_SOLR6_JAVA_XMX:-1g}"
	echo ""
	echo "  Services:"
	echo ""
	echo "    HTTP:           http://127.0.0.1:${REPOSITORY_SEARCH_SOLR6_PORT_HTTP:-8200}/solr/"
	echo "    JPDA:           127.0.0.1:${REPOSITORY_SEARCH_SOLR6_PORT_JPDA:-8201}"
	echo ""
	echo "#########################################################################"
	echo ""
